...
// test('Transfer funds Letter error', async ({ page }) => {
...
//     await transferFundsPage.insertMoneyToBeTransferred('N/A');
...
//     //Error message shows
//     const h1Visible = await page.waitForSelector('#amount\\.errors', { visible: true });
